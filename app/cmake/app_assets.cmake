...
set(SHARED_STATIC_ASSETS ${PROJECT_SOURCE_DIR}/app/assets/fonts/Manrope.ttf)

# Platform specific static assets
if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
  target_sources(${NAME} PUBLIC
    ${SHARED_STATIC_ASSETS}
    ${PROJECT_SOURCE_DIR}/app/assets/icons/icon.ico
    ${PROJECT_SOURCE_DIR}/app/Manifests/app.rc
    ${PROJECT_SOURCE_DIR}/app/Manifests/App.manifest)
elseif (CMAKE_SYSTEM_NAME STREQUAL "Darwin")
  set(MACOSX_STATIC_ASSETS
    ${SHARED_STATIC_ASSETS}
    ${PROJECT_SOURCE_DIR}/app/assets/icons/icon.icns)
